...
public final class AlertCommand implements BotCommand {
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    try {
      command.action(parameters.get("message") != null ? (String)parameters.get("message").get() : (String)null ,parameters.get("type") != null ? (String)parameters.get("type").get() : (String)null );Optional<Value> result = Optional.empty();
