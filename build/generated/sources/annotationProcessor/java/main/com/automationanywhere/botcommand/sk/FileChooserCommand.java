...
public final class FileChooserCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(FileChooserCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    FileChooser command = new FileChooser();
