...
public final class ShowDictonaryCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(ShowDictonaryCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    ShowDictonary command = new ShowDictonary();
    ...
    try {
      command.action(parameters.get("dict") != null ? (HashMap<String, Value>)parameters.get("dict").get() : (HashMap<String, Value>)null ,parameters.get("label") != null ? (String)parameters.get("label").get() : (String)null ,parameters.get("width") != null ? (Double)parameters.get("width").get() : (Double)null ,parameters.get("height") != null ? (Double)parameters.get("height").get() : (Double)null );Optional<Value> result = Optional.empty();
