...
public final class TwoButtonsCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(TwoButtonsCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    TwoButtons command = new TwoButtons();
    ...
    try {
      Optional<Value> result =  Optional.ofNullable(command.action(parameters.get("title") != null ? (String)parameters.get("title").get() : (String)null ,parameters.get("label") != null ? (String)parameters.get("label").get() : (String)null ,parameters.get("button1") != null ? (String)parameters.get("button1").get() : (String)null ,parameters.get("button2") != null ? (String)parameters.get("button2").get() : (String)null ));
