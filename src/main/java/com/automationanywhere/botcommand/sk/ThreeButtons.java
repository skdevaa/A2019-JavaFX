...
public class ThreeButtons  {
	...
	public Value<String> action(@Idx(index = "1", type = TEXT) @Pkg(label = "Title", default_value_type = STRING) @NotEmpty String title ,
								...
								@Idx(index = "3", type = TEXT) @Pkg(label = "Button1", default_value_type = STRING) @NotEmpty String button1, 
		  						@Idx(index = "4", type = TEXT) @Pkg(label = "Button2", default_value_type = STRING) @NotEmpty String button2,
		  						@Idx(index = "5", type = TEXT) @Pkg(label = "Button3", default_value_type = STRING) @NotEmpty String button3) throws Exception {
  ...
  private  void initFX(String label, String button1, String button2, String button3) {
    	 ...
    	 hbButtons.getChildren().addAll(but1,but2,but3);
